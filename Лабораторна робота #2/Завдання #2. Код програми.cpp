// Лабораторна робота #2. Завдання #2 (складний варіант).
...
int main()
{
	...
	cout << "Fx = " << Fx(a,x) << "; Fy = " << Fy(x) << "; Fz = " << Fz(b,x) << endl;
	cout << "Fx + Fy = " << Fx(a,x) + Fy(x) << "; ";
	cout << "Fxy / Fz = " << ( Fx(a,x) + Fy(x) ) / Fz(b,x) << endl;
	cout << "Y = " << ( Fx(a,x) + Fy(x) ) / Fz(b,x) << endl << endl;
